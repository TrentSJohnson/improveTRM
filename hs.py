...
class HS:
    def get_weight(self,graph,node1,node2,constrain_type,cwgraph):
        ...
        return self.euc_dis(cwgraph.nodes[underflow]['x'], cwgraph.nodes[underflow]['y'], cwgraph.nodes[worker]['xe'], cwgraph.nodes[worker]['ye']) + self.euc_dis(cwgraph.nodes[overflow]['x'], cwgraph.nodes[overflow]['y'], cwgraph.nodes[underflow]['x'], cwgraph.nodes[underflow]['y']) + self.euc_dis(cwgraph.nodes[overflow]['x'], cwgraph.nodes[overflow]['y'], cwgraph.nodes[worker]['xs'], cwgraph.nodes[worker]['ys'])
